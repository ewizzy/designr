...
function designr_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'Designr Addons', // The plugin name.
			'slug'               => 'designr-addons', // The plugin slug (typically the folder name).
			'source'             => get_template_directory() . '/includes/tgm/plugins/designr-addons.zip', // The plugin source.
